...
let input5 = processInput5()
start = DispatchTime.now()
print("Day 5, part 1: \(binaryBoarding(arr: input5))")
end = DispatchTime.now()
nanoTime = end.uptimeNanoseconds - start.uptimeNanoseconds
timeInterval = Double(nanoTime) / 1_000_000_000
print("Time to evaluate problem 5.1: \(timeInterval) seconds")

start = DispatchTime.now()
print("Day 5, part 2: \(binaryBoarding2(arr: input5))")
end = DispatchTime.now()
nanoTime = end.uptimeNanoseconds - start.uptimeNanoseconds
timeInterval = Double(nanoTime) / 1_000_000_000
print("Time to evaluate problem 5.2: \(timeInterval) seconds")
